...
public partial class UrlHasher : IUrlHasher
{
    ...
    public UrlHasher(String salt = "", Int32 minimumHashLength = 0, String alphabet = DEFAULT_ALPHABET, String separators = DEFAULT_SEPARATORS)
    {
        if (salt == null)
        {
    ...
    private static (Char[] alphabetChars, Char[] separatorChars, Char[] guardChars) InitializeCharacterArrays(String alphabet, String separators, ReadOnlySpan<char> salt)
    {
        ...
        {
            var separatorsLength = (int)Math.Ceiling(alphabetChars.Length / _separator_Divisions);
        ...
        var guardCount = (int)Math.Ceiling(alphabetChars.Length / _guard_Divisions);
    ...
    private String GenerateHashFrom(ReadOnlySpan<Int64> numbers)
    {
        ...
        var builder = _builderPool.GetStringBuilderFromPool;
        ...
        _builderPool.ReturnStringBuilderToPool(builder);
    ...
    public virtual int DecodeSingleValue(string hash)
    {
    ...
    public virtual long DecodeSingleLong(String hash)
    {
        var numbers = GetNumbersFrom(hash);
    ...
    public virtual (bool isSuccessful, int value) TryDecodeSingleValue(string hash)
    {
    ...
    public virtual (bool isSuccessful, long value) TryDecodeSingleLong(string hash)
    {
    ...
    public virtual int[] DecodeValuesAsIntegers(string hash) => Array.ConvertAll(GetNumbersFrom(hash), n => (int)n);
    ...
    public virtual string DecodeHexValue(string hash)
    {
        var builder = _builderPool.GetStringBuilderFromPool;
    ...
    public virtual string EncodeIntegers(IEnumerable<int> numbers) => EncodeIntegers(numbers.ToArray());

    public virtual string EncodeIntegers(params int[] numbers) => GenerateHashFrom(Array.ConvertAll(numbers, n => (long)n));
